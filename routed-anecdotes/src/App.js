  ...
  return (
    ...
    <div>
      ...
      <div>
        ...
        {notification?(<h3>{notification}</h3>):(null)}
          <Switch>
            <Route exact path="/about"><About /></Route>
            <Route exact path="/createNew"><CreateNew addNew={addNew} /></Route>
            <Route exact path="/anecdotes/:id"><Anec anecdotes={anecdotes} /></Route>
